...
//        JSQMessagesAvatarImage *wozImage = [avatarFactory avatarImageWithImage:[UIImage imageNamed:@"demo_avatar_woz"]];
         ...
         */
        // 气泡图片制作工具类
        JSQMessagesBubbleImageFactory *bubbleFactory = [[JSQMessagesBubbleImageFactory alloc] initWithBubbleImage:[UIImage jsq_bubbleRegularStrokedImage] capInsets:UIEdgeInsetsZero];
        // 发出去的气泡颜色
...
//    }
     ...
     */
    // 设置一坨非常长的聊天气泡
    if ([[NSUserDefaults standardUserDefaults] valueForKey:@"kLongMessages"]) {
