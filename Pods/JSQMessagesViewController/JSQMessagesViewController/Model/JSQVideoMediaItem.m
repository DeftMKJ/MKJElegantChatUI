...
- (UIView *)mediaView
{
    ...
    if (self.cachedVideoImageView == nil) {
        ...
        // 获取帧数图片
        UIImage *playIcon1 = [UIImage thumbnailImageForVideo:_fileURL atTime:1.0];
        
        UIImage *imageFinal = [UIImage addImage:playIcon1 withImage:playIcon];
        
        UIImageView *imageView = [[UIImageView alloc] initWithImage:imageFinal];
